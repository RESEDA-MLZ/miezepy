...
"")
        ...
        self.verticalLayout_411l = QtWidgets.QVBoxLayout()
        self.verticalLayout_411l.setObjectName("verticalLayout_411l")
        self.data_label = QtWidgets.QLabel("Dataset:")
        self.data_label.setStyleSheet("font-weight: bold;")
        self.verticalLayout_411l.addWidget(self.data_label)
        self.verticalLayout_411 = QtWidgets.QVBoxLayout()
        self.verticalLayout_411.setObjectName("verticalLayout_411")
        self.verticalLayout_411l.addLayout(self.verticalLayout_411)
        self.verticalLayout_41.addLayout(self.verticalLayout_411l)
        #
        ...
        self.add_errorbars = QtWidgets.QCheckBox(self.dataselect_group)
        ...
        self.verticalLayout_412.addWidget(self.add_errorbars)
