...
"background-color: rgb(98, 12, 53);}")
        ...
        self.logo_label = QtWidgets.QPushButton(self.main_widget)
...
"} ")
        ...
        self.logo_label.setIconSize(QtCore.QSize(70, 70))
        ...
        self.label_2.setStyleSheet("#label_2{ color :rgb(255, 255, 255)}")
...
"")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1337, 27))
    ...
    def retranslateUi(self, MIEZETool):
        ...
        self.label_2.setText(_translate("MIEZETool", "MIEZEPY"))
