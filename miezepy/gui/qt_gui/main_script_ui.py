...
"#tab{background-color: rgb(131, 131, 131);}")
        ...
        self.fit_sum_foils = QtWidgets.QCheckBox('Sum foils', self.groupBox_3)
        self.fit_sum_foils.setObjectName("fit_sum_foils")
        self.fit_select_layout.addWidget(self.fit_sum_foils)
